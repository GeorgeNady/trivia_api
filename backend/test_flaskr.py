...
class TriviaTestCase(unittest.TestCase):
	...
	def test_search_for_question(self):
		res = self.client().post('/questions/search', {'searchTerm': 'what'})
		data = json.loads(res.data)
	...
	def test_400_sent_requesting_beyond_valid_page(self):
		res = self.client().get('/questions?page=1000', {'rating': 1})
		data = json.loads(res.data)
	...
	def test_405_sent_requesting_beyond_valid_page(self):
		res = self.client().get('/questions?page=1000', {'rating': 1})
		data = json.loads(res.data)
